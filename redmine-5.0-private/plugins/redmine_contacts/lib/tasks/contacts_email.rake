...
END_DESC
      ...
      task :read => :environment do
        ...
        ContactsMailHandler.receive(STDIN.read, options)
      end
...
END_DESC
      ...
      task :receive_imap => :environment do
        ...
        RedmineContacts::Mailer.check_imap(ContactsMailHandler, imap_options, options)
      end
...
END_DESC
      ...
      task :receive_pop3 => :environment do
        ...
        RedmineContacts::Mailer.check_pop3(ContactsMailHandler, pop_options, options)
      end
